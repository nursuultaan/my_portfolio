...
return (
    <section ref={scrollTab} className='home'>
        <div className="content">
            <div className="name">
                MY NAME IS <span>Sultan</span>
            </div>
            <div className="des">
                {/* 30 */}
                "Hi, I'm Sultan! I’m a code enthusiast with a passion for turning caffeine into lines of JavaScript (and occasionally bugs). I love creating things, whether it's a slick web app or just the perfect excuse to avoid cleaning my desk. If you know me,
